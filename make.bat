...
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -DUSE_SFR_FOR_REG -c -o build\home.o home.c
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wf-bo1 -Wf-ba1 -DUSE_SFR_FOR_REG -c -o build\pet_status.o pet_status.c
c:\gbdk\bin\lcc -Wa-l -Wl-m -Wl-j -Wf-bo1 -Wf-ba1 -DUSE_SFR_FOR_REG -c -o build\pet_messages.o pet_messages.c
